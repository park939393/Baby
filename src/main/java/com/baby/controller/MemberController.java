...
//			logger.info("memberIdChk()진입");
	...
	public String myPageMainGET(@PathVariable("memberId") String memberId, Model model) throws Exception {

		model.addAttribute("memberInfo", MemberService.getMemberInfo(memberId));

		System.out.println(MemberService.getMemberInfo(memberId));
	...
	/* 마이 페이지 비밀번호 변경 이동 */
	@GetMapping("/myPageModify/{memberId}")
	public String myPageModifyGET(@PathVariable("memberId") String memberId, Model model) throws Exception {

		model.addAttribute("memberInfo", MemberService.getMemberInfo(memberId));
		
		logger.info("비밀번호 변경 페이지 이동");
		
		return "member/myPageModify";
	}

	/* 마이 페이지 회원 탈퇴 이동 */
	@GetMapping("/myPageDelete/{memberId}")
	public String myPageDeleteGET(@PathVariable("memberId") String memberId, Model model) throws Exception {
	...
	public String orderListGET(@PathVariable("memberId") String memberId, Model model) {

		model.addAttribute("memberInfo", MemberService.getMemberInfo(memberId));
		
		List<OrderDTO> list = MemberService.getMyOrderList(memberId);
