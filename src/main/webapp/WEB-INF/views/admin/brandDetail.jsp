                   		...
                   		<div class="form_section">
                   			...
                   			<div class="form_section_content">
                   				<select class="input_block" name="nationId" >
                   					...
                   					<option value="01" disabled="disabled" <c:out value=" ${brandInfo.nationId eq '01' ?'selected':''}"/>>국내</option>
                   					<option value="02" disabled="disabled" <c:out value=" ${brandInfo.nationId eq '02' ?'selected':''}"/>>국외</option>
                   				</select>
                   			</div>
                   		</div>
                   		<div class="form_section">
