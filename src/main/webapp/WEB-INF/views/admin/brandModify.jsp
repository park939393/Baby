...
<body>
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input class="input_block" name="brandId" readonly="readonly"
							value="<c:out value='${brandInfo.brandId }'></c:out>">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input name="brandName"
							value="<c:out value='${brandInfo.brandName }'></c:out>">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<select name="nationId">
							...
							<option value="01"
								<c:out value=" ${brandInfo.nationId eq '01' ?'selected':''}"/>>국내</option>
							<option value="02"
								<c:out value=" ${brandInfo.nationId eq '02' ?'selected':''}"/>>국외</option>
						</select>
					</div>
				</div>
				<div class="form_section">
					...
					<div class="form_section_content">
						<textarea name="brandIntro"><c:out
								value='${brandInfo.brandIntro }' /></textarea>
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input class="input_block" type="text" readonly="readonly"
							value="<fmt:formatDate value="${brandInfo.regDate}" pattern="yyyy-MM-dd"/>">
					</div>
				</div>
				<div class="form_section">
					<div class="form_section_title">
					...
					<div class="form_section_content">
						<input class="input_block" type="text" readonly="readonly"
							value="<fmt:formatDate value="${brandInfo.updateDate}" pattern="yyyy-MM-dd"/>">
					</div>
				</div>
	...
	<form id="moveForm" method="get">
		<input type="hidden" name="brandId"
			value='<c:out value="${brandInfo.brandId }"/>'> <input
	...
	<script>
		...
		$("#modifyBtn").on(
				...
				function(e) {
					...
					let brandName = $(
							".form_section_content input[name='brandName']")
							.val();
