...
<link rel="stylesheet" href="../resources/css/admin/brandPop.css">
...
<body>
					...
					<table class="brand_table">
						<thead>
							<tr>
								...
								<td class="th_column_3">브랜드 국가</td>
							</tr>
						</thead>
						<c:forEach items="${list}" var="list">
							<tr>
								...
								<td>
								<a class="move"
									href='<c:out value="${list.brandId}"/>'
									data-name='<c:out value="${list.brandName}"/>'> 
	...
	<script>
		...
		$(".move").on("click", function(e){
			...
			$(opener.document).find("#brandId_input").val(brandId);
