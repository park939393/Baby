...
<%@include file="../includes/admin/header.jsp" %>
                    ...
                    <div class="admin_content_main">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input name="productName" value="<c:out value="${productInfo.productName}"/>" disabled>
                    			</div>
                    		</div>
                    		<div class="form_section">
                    			<div class="form_section_title">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input value="<fmt:formatDate value='${productInfo.updateDate}' pattern='yyyy-MM-dd'/>" disabled>
                    			</div>
                    		</div>                    		                    		
                    		<div class="form_section">
                    			<div class="form_section_title">
                    			...
                    			<div class="form_section_content">
                    				<input id="brandName_input" readonly="readonly" value="${productInfo.brandName }" disabled>
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input name="releaseDate" autocomplete="off" readonly="readonly" value="<c:out value="${productInfo.releaseDate}"/>" disabled>                    				
                    			</div>
                    		</div>            
                    		<div class="form_section">
                    			<div class="form_section_title">
                    			...
                    			<div class="form_section_content">
                    				<input name="company" value="<c:out value="${productInfo.company}"/>" disabled>
                    			</div>
                    		</div>             
                    		<div class="form_section">
                    			<div class="form_section_title">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input name="productPrice" value="<c:out value="${productInfo.productPrice}"/>" disabled>
                    			</div>
                    		</div>               
                    		<div class="form_section">
                    			<div class="form_section_title">
                    			...
                    			<div class="form_section_content">
                    				<input name="productStock" value="<c:out value="${productInfo.productStock}"/>" disabled>
                    			</div>
                    		</div>          
                    		<div class="form_section">
                    			<div class="form_section_title">
		...
		$("#modifyBtn").on("click", function(e){
			e.preventDefault();
			let addInput = '<input type="hidden" name="productId" value="${productInfo.productId}">';
