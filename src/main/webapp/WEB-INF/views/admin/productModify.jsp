	...
	<div class="admin_content_wrap">
		...
		<div class="admin_content_main">
			<form action="/admin/productModify" method="post" id="modifyForm">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input id="brandName_input" readonly="readonly"
							value="${productInfo.brandName}"> <input
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input name="company" value="${productInfo.company}"> <span
							class="ck_warn company_warn">판매처를 입력해주세요.</span>
					</div>
				</div>
				<div class="form_section">
					<div class="form_section_title">
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<input id="discount_interface" maxlength="2" value="0"> <input
							name="productDiscount" type="hidden"
							value="${productInfo.productDiscount}"> <span
		...
		<form id="moveForm" action="/admin/productManage" method="get">
			<input type="hidden" name="pageNum" value="${cri.pageNum}"> <input
				...
				type="hidden" name='productId' value="${productInfo.productId}">
		</form>
	</div>
