			...
			<c:if test="${listcheck !='empty'}">
				<div class="search_filter">
					<div class="filter_button_wrap">
						<button class="filter_button filter_active" id="filter_button_a">국내
							상품</button>
						<button class="filter_button" id="filter_button_b">해외 상품</button>
					</div>
								...
								<tr>
									<td class="image">
										<div class="image_wrap"
											data-bookid="${list.imageList[0].productId}"
									...
									<td class="price">
										...
										<div class="sell_price">
											<strong> <fmt:formatNumber
													value="${list.productPrice * (1-list.productDiscount)}"
													pattern="#,### 원" />
											</strong>
										</div>
									</td>
	...
	$(document)
			.ready(
					function() {
						...
						if (selectedType != "") {
							$("select[name='type']").val(selectedType).attr(
									"selected", "selected");
						}
										...
										function(i, obj) {
											...
											if (bobj.data("filename")) {
												...
												$(this)
														.find("img")
														.attr('src',
																'/resources/img/productNoImage.png');
											}
										});
